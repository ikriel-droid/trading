...
The UI now includes runtime cards, price chart, signal and backtest actions, candle sync, market scan, live reconcile, key config editing, and start or stop controls for background paper or live jobs.
