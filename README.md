...
The UI now includes runtime cards, price chart, signal and backtest actions, candle sync, market scan, live reconcile, and an editable config panel for key strategy fields.
